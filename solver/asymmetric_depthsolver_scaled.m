...
%%
% 
% 08/11/09: Take -h- values of depths to be asymmetric.
...
% 
function [T_TL_max,discard_flag]=asymmetric_depthsolver_scaled( n, D, lambda, a, hrange_cartprod )
...
%
% asymmetric_depthsolver_scaled(2, [300 200 150 250], 324,\
%                                         [50 40 40 50] )
%
