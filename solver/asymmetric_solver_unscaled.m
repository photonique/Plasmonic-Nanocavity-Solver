...
%% 
% 
% 08/10/09: adapt to the unscaled-waist coupling in asymmetric case.
% 
...
function [T_TL_max]=asymmetric_solver_scaled( n, D, lambda, a, h )
   ...
   if ( nargin < 3 ), error('asymmetric_solver_unscaled(n,D,lambda,a,h'), end;
   ...
   %a0=1400; 
   a0=1400;%unscaled waist of Gaussian mode
   spot=a0/a;
   k=2*pi/lambda;
   kappa=k*a;
